    ...
    <section className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <p>
          ...
          sent to the {GOOGLE_MODEL_NAME} model to generate responses. The
          specifics of how the model processes this data are not disclosed to
          us.
        </p>
        <H2>Use of Information</H2>
        <p>
          The user input we collect is used solely for the purpose of generating
          responses within the app.
        </p>
        ...
        <H2>Security</H2>
        <p>
          The security of your information is important to us. Please note that
