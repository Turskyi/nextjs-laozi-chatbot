    ...
    <section className="space-y-6">
      ...
      <section className="space-y-3">
        ...
        <ul className="list-inside list-disc space-y-1">
          <li>
            <a href={FACEBOOK} className="text-primary hover:underline">
              Facebook
            </a>
          </li>
          <li>
          ...
          <li>
            <a href={INSTAGRAM} className="text-primary hover:underline">
              Instagram
            </a>
          </li>
        </ul>
      ...
      <section className="space-y-3">
        ...
        <ul className="list-inside list-disc space-y-1">
          <li>
            <a href={YOUTUBE} className="text-primary hover:underline">
              Daoism playlist
            </a>{' '}
          ...
          <li>
            <a href={YOUTUBE_SHORTS} className="text-primary hover:underline">
